...
float4 OperationBlend_1 = OperationBlend(_PremadeGradients_1, SourceRGBA_1, _OperationBlend_Fade_1); 
float4 _ShinyFX_1 = ShinyFX(OperationBlend_1,i.texcoord,_ShinyFX_Pos_1,_ShinyFX_Size_1,_ShinyFX_Smooth_1,_ShinyFX_Intensity_1,_ShinyFX_Speed_1);
float4 OperationBlend_2 = OperationBlend(NewTex_1, _ShinyFX_1, _OperationBlend_Fade_2); 
